        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                if (isset($_POST['btnsimpan'])) {
                    ...
                    if (empty($nilai_un) || empty($nilai_us)) {
                        echo "Silahkan lengkapi semua nilai.";
                    } else {
                        // Periksa apakah status masih "Baru"
                        if ($s['status'] == 'Baru') {

                            // Lakukan proses penyimpanan data ke database
                            $edit = $koneksi->query("UPDATE pendaftar SET nilai_un='$nilai_un', nilai_us='$nilai_us'");

                            if ($edit) {
                                echo "<script>alert('Data berhasil diubah'); window.location='nilai.php?id=$id_pendaftar';</script>";
                            } else {
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <p class="text-danger mt-1">* Ubah jika ada kesalahan!</p>
                                    <form class="user" method="POST">
                                        <div class="form-group" action>
                                            <label for="nilai_un">Nilai Ujian Nasional</label>
                                            <input type="text" name="nilai_un" class="form-control" id="nilai_un" placeholder="Masukkan Nilai Ujian Nasional" value="<?= $s['nilai_un'] ?>" required>
                                        </div>
                                        <div class=" form-group">
                                            <label for="nilai_us">Nilai Ujian Sekolah</label>
                                            <input type="text" name="nilai_us" class="form-control" id="nilai_us" placeholder="Masukkan Nilai Ujian Sekolah" value="<?= $s['nilai_us'] ?>" required>
                                        </div>
                                        <button type=" submit" name="btnsimpan" class="btn btn-primary mb-5">Ubah</button>
