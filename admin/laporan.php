...
$query_total_pendaftar = "SELECT COUNT(*) AS total_pendaftar FROM pendaftar";
$result_total_pendaftar = $koneksi->query($query_total_pendaftar);
$row_total_pendaftar = $result_total_pendaftar->fetch_assoc();
$total_pendaftar = $row_total_pendaftar['total_pendaftar'];
?>
<!DOCTYPE html>
<html lang="en">
...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h2 mb-4 text-gray-800">Laporan</h1>
                            ...
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="h4 font-weight-bold text-info text-uppercase mb-1"><a href="template.php" class="text-info">Pendaftar Lolos</a></div>
                        ...
                        <div class="col-md-6">
                            <div class="card border-left-warning shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="h4 font-weight-bold text-warning text-uppercase mb-1"><a class="text-warning" href="template_tidaklolos.php">Pendaftar Tidak Lolos</a></div>
                        ...
                        <div class="col-xl-4 col-md-6 mb-3 mt-3">
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1"><a href="templateatph.php" class="text-success">Agribisnis Tanaman Pangan Dan Hortikultura (ATPH)</a></div>
                        ...
                        <div class="col-xl-4 col-md-6 mb-3 mt-3">
                            <div class="card border-left-danger shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-danger text-uppercase mb-1"><a href="templaterpl.php" class="text-danger">Rekayasa Perangkat Lunak (RPL)</a></div>
                        ...
                        <div class="col-xl-4 col-md-6 mb-3 mt-3">
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1"><a href="templatetsm.php">Teknik Bisnis Sepeda Motor (TBSM)</a></div>
    ...
    <<script>
        function updateDataPendaftarLolos() {
        ...
        updateDataPendaftarLolos(); // Panggil fungsi pertama kali untuk memuat data
        setInterval(updateDataPendaftarLolos);
        </script>
        ...
        <script>
            ...
            updateDataTidakLolos(); // Panggil fungsi pertama kali untuk memuat data
